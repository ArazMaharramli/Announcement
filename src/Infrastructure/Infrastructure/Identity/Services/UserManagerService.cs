...
public class UserManagerService : IUserManager
{
    ...
    public async Task ClearUserClaims(string userId, CancellationToken cancellationToken)
    {
    ...
    public async Task AddUserClaims(string userId, List<string> claimNames)
    {
        var user = await _userManager.FindByIdAsync(userId);
        if (user is null)
        {
