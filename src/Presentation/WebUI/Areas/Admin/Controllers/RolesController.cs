...
using WebUI.Models;
using Application.CQRS.Managers.Queries.SearchByRole;
using Application.CQRS.Roles.Commands.Delete;
...
public class RolesController : Controller
{
    ...
    [HttpPost]
    [Authorize(Policy = SystemClaims.Roles.Delete)]
    public async Task<IActionResult> Delete([FromBody] DeleteRoleCommand command, CancellationToken cancellationToken)
    {
        await _mediator.Send(command, cancellationToken);
        return Ok();
    }
