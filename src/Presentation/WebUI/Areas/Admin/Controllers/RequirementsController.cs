...
public class RequirementsController : BaseController
{
    ...
    // GET: /<controller>/
    [Authorize(Policy = SystemClaims.Requirements.Show)]
    ...
    [HttpGet]
    [Authorize(Policy = SystemClaims.Requirements.Create)]
    ...
    [HttpGet]
    [Authorize(Policy = SystemClaims.Requirements.Edit)]
    ...
    [HttpPost]
    [Authorize(Policy = SystemClaims.Requirements.Delete)]
